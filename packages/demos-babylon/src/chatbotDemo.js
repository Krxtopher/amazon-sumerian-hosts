...
class ConversationController {
  constructor(host, lexFeature) {
    ...
    const { lexResponseReady } = HOST.aws.LexFeature.EVENTS;

    this.lex.listenTo(lexResponseReady, (response) => this.#handleLexResponse(response));
  }
  ...
  #handleLexResponse(response) {
    ...
    this.#displayTranscript(inputTranscript);
  }
