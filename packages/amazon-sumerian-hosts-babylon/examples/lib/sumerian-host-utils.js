 ...
 *
 * @param assetsPath {string} URL of a folder containing the "characters" and
 * "animations" subfolders containing the standard host 3D assets.
 * @param characterId {string} The ID of the character to be created. Available
 * character IDs are:
 * - "Cristine"
 * - "Fiona"
 * - "Grace"
 ...
 * - "Preston"
 * - "Wes"
 * @returns {object} Object describing the assets needed to build one of the
 * eight built-in Sumerian Host characters. The shape of the returned config
 * object is:
 * {
 *   modelUrl: String, gestureConfigUrl: String, pointOfInterestConfigUrl:
 *   String, animStandIdleUrl: String, animLipSyncUrl: String, animGestureUrl:
 *   String, animEmoteUrl: String, animFaceIdleUrl: String, animBlinkUrl:
 *   String, animPointOfInterestUrl: String,
 * }
 */
...
const SumerianHostUtils = {
  createHost,
  getCharacterConfig,
};

export default SumerianHostUtils;